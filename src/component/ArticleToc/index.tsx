...
const ArticleToc: React.FC<ArticleTocProps> = ({tocMarkdown, width, cover}) => {
    ...
    return (
        <div className={`m-0 ml-auto relative ${width}`}>
            <div className="sticky top-[4rem] 2xl:top-[3.6rem] bg-transparent flex flex-col items-start">
                ...
                <div className="blog-cover w-full bg-transparent top-[calc(4rem + 60vh)] 2xl:top-[calc(3.6rem + 50vh)] mt-2r ">
